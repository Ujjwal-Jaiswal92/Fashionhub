    ...
    public function getApprovedProducts($filters = [])
{
    ...
    */
    public function deleteProduct()
    {
        ...
        if (($_SESSION['role'] ?? '') !== 'seller' || !$this->product->belongsToSeller((int)$_GET['id'], $_SESSION['user_id'])) {
    ...
    */
    public function approveProduct()
    {
        ...
        if (($_SESSION['role'] ?? '') !== 'admin') { die('Admin access required.'); }
